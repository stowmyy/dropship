...
struct ImGuiSettingsHandler
{
    ...
    void*       (*ReadOpenFn)(ImGuiContext* ctx, ImGuiSettingsHandler* handler, const char* title);              // Read: Called when entering into a new ini entry e.g. "[Window][Name]"
...
public:
    ImGuiWindow(ImGuiContext* context, const char* title);
    ~ImGuiWindow();
...
namespace ImGui
{
    ...
    IMGUI_API ImGuiWindow*  FindWindowByName(const char* title);
    ...
    // Settings - Windows
    IMGUI_API ImGuiWindowSettings*  CreateNewWindowSettings(const char* title);
    IMGUI_API ImGuiWindowSettings*  FindWindowSettingsByID(ImGuiID id);
    IMGUI_API ImGuiWindowSettings*  FindWindowSettingsByWindow(ImGuiWindow* window);
    IMGUI_API void                  ClearWindowSettings(const char* title);
...
//#endif
    ...
    IMGUI_API bool          BeginChildEx(const char* title, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    // Menus
    IMGUI_API bool          BeginViewportSideBar(const char* title, ImGuiViewport* viewport, ImGuiDir dir, float size, ImGuiWindowFlags window_flags);
    ...
    IMGUI_API bool          BeginTableEx(const char* title, ImGuiID id, int columns_count, ImGuiTableFlags flags = 0, const ImVec2& outer_size = ImVec2(0, 0), float inner_width = 0.0f);
