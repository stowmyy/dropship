    ...
    endpoints({
        ...
        */
        ...
        // https://ipinfo.io/AS57976/137.221.68.0/24
        {
            ...
            .heading=                 "LAX1, LAS1 and GUW2",
            ._firewall_rule_address=  ips.at("lax1") + "," + ips.at("las1") + "," + ips.at("guw2"),
            ._firewall_rule_description =             "Blocks LAX1, LAS1 and GUW2",
            .favorite=                true,
        },
        ...
        // https://ipinfo.io/AS57976/137.221.64.0/19-137.221.65.0/25
        {
            ...
            .heading = "ICN1 and GAN3",
            ._firewall_rule_address = ips.at("icn1") + "," + ips.at("gan3"),
            ._firewall_rule_description = "Blocks ICN1 and GAN3",
        },
        ...
        // TODO: germany, bahrain, korea3, na east. offline currently.
